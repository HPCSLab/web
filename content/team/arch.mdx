...
description_en: |
  We conduct research on networks and accelerators, in particular on parallel processing architectures and networks that use accelerators such as FPGAs and GPUs.
bachelorInfo:
  capacities:
    - faculties:
        - tsuji
