...
There was also a problem of degraded performance when flushing modified data back to the parallel file system,
which we address by proposing an I/O-aware flushing mechanism.
